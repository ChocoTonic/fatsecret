...
# Exceptions moved to `fatsecret.errors` to centralize error types.
# They are imported at module level near the top of this file to preserve
# backward compatibility for code importing from `fatsecret.fatsecret`.
